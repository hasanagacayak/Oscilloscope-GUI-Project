...
namespace Oscilloscope
{
    public partial class Ch3 : Form
    {
        ...
        {
            RTA4004_scope.VerticalSettings(3, comboBox1.Text, textBox7.Text, textBox1.Text, textBox3.Text, comboBox5.Text, comboBox6.Text, comboBox7
               .Text, textBox4.Text, textBox5.Text, comboBox10.Text, textBox6.Text, comboBox11.Text); //Ch3 formunda kullanıcının girdiği değerleri Oscilloscope'a akatarmak için kullanılır.
        }
    }
}
